...
- **demo.gif**: A visual walkthrough of the Streamlit dashboard highlighting the Grad-CAM capabilities and patient network integration.
...
3. Save the output as `demo.gif` in this directory.
